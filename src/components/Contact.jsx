                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <div className="ml-4">
                        ...
                        <a href="https://www.linkedin.com/in/kyle/" className="text-gray-400 hover:text-blue-300 transition-colors duration-300 hover:translate-x-1">
                          linkedin.com/in/kyle
                        </a>
                      </div>
                    </motion.div>
                  </div>
